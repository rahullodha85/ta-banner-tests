...
public class Scen05  extends ScenarioSaks{
	...
	public void executeScript() throws Exception {
		...
		shp.AddShippingAddress(false, "8800 Heritage Center Drive", "Anchorage", "Alaska", "99506",false);
		shp.ClickCheckoutOptionalAddressConfirmation();
		pap.AddNewCreditCard(3);
		pap.ClickCheckout();
	
		WebserviceValidation.isReturningFdxShpngDts(Address.createAddress("Tester", "Automation", "8800 Heritage Center Drive", "Anchorage", "AK", "99506", "9176132888"));
