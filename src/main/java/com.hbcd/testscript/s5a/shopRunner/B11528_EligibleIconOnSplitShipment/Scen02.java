...
public class Scen02 extends ScenarioChkout {
    ...
    public void executeScript() throws Exception {
        ...
        //   Two Ineligible Items - Splits the shipment - ShopRunner Eligible Icon should not disply on both items
        ...
        rsp.EnterNewShippingAddress(item1, "445 east 96th st", "New York", "New York", "10017", false);
