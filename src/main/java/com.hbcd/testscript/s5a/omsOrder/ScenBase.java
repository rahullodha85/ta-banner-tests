 ...
 */
public class ScenBase extends ScenarioCommonPlatform {

    protected String _scenarioNumber = "";
    //Build List Item.
    ...
    public void executeScript() throws Exception {
        ...
        new OrderHappyPath(this)
                .setRegisterUserAccount(readAccountLogin(_scenarioNumber))
                .setShopRunnerAccount(readShopRunnerLogin(_scenarioNumber))
                .setItemList(readItem(_scenarioNumber))
                .setAddressList(readAddress(_scenarioNumber))
                .setTenderList(readTender(_scenarioNumber))
                .setShippingMethod(readShipMethod(_scenarioNumber))
                .CheckOut();
    }
