 ...
 */
public class editMenuNavigationComponent extends ScenarioAEMAuthor {
    ...
    public void executeScript() throws Exception {
        ...
        // Test - Edit Menu navigation

        // Find global promotion message tool bar and click on edit button

        Thread.sleep(5000);
        Find.Object("ep_globalMenuNavigation_Edit_toolbar").storeAs("container");
        String html = Use.CapturedObject("container").AsIs().getAttribute("innerHTML").value();
        Log.Info(html);

        try {
            Use.CapturedObject("container").FindObject("ep_globalMenuNavigation_Edit_button").click();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        Find.Object("ep_menuNavigationBackButtonLabel").clear();
        Find.Object("ep_menuNavigationBackButtonLabel").input("Back");
        ...
        //Populate Link label Flyout node

        Find.Object("ep_menuNavigationLinkLabel").clear();
        Find.Object("ep_menuNavigationLinkLabel").input("Mens");
        Find.Object("ep_menuNavigationFlyoutNode").clear();
        Find.Object("ep_menuNavigationFlyoutNode").input("/content/sof/en_us/flyouts/Men/jcr:content/flexi_hero_par/headernavflyout");

        String ss = BrowserAction.screenshot();
        Report.pass("SCreenshot before ok button", ss);
        ...
        //Find.Object("ep_menuNavigationOkButton").click();
        //x-panel-btns

        ss = BrowserAction.screenshot();
        Report.pass("Edited Menu Navigation component", ss);
