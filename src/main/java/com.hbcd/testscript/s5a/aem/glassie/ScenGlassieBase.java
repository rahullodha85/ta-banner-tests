...
public class ScenGlassieBase extends ScenarioAEMGlassie {
	/**
	...
	public void executeScript() throws Exception {
		...
		try {
			...
			if (header.contains("true")) {
				Object retData[] = validateContent(input, line, content, valid, message, prodname, expectedValue);
            ...
            Report.end_script("API Test passed", "");
            //Report.pass("API passed", ss);
        }
	...
	public String[] makeCurlUrl(String argData) {
		...
		java.util.HashMap x = (HashMap) JSON.parse(argData);
