 ...
 */
public class Scen_B12157_Changing_the_Selected_Shipping_Method extends ScenarioChkout {
    public void executeScript() throws Exception {

        /*
        Scenario: Update Shipping Cost When Changing the Shipping Method (Paying Duties and Taxes Now)

        GIVEN I have changed the selected shipping method
        WHEN the order summary dynamically updates
        THEN display the shipping cost for the respective shipping method

        Scenario: Update Duties & Taxes When Changing the Shipping Method

        GIVEN I have changed the selected shipping method
        AND I have selected to pay duties and taxes now
        WHEN the order summary dynamically updates
        THEN display the Duties & Tax cost for the respective shipping method

        Scenario: Update Duties & Taxes When Changing the Shipping Method (Paying Duties and Taxes Upon Delivery)


        GIVEN I have changed the selected shipping method
        AND I have selected to pay duties and taxes upon delivery
        WHEN the order summary dynamically updates
        THEN display “UNPAID” in place of the duties and tax cost
       ...
       /* nav.ChangeCountry("India");
        ...
        //Should be unpaid
        ValidateShippingBilling.hasDutiesAndTaxUnpaid();
