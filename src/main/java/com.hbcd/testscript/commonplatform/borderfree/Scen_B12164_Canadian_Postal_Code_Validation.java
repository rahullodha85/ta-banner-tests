 ...
 */
public class Scen_B12164_Canadian_Postal_Code_Validation extends ScenarioChkout {
    public void executeScript() throws Exception {

       /*
        Scenario: Provide a Prepopulated Province Dropdown
        (Reference notation #10 in attachment: International_ShippingPage_ToBe.jpg)
...
*/
        ...
        //******************
        shp.AddShippingAddress(false, dataObject.getAddress1(), dataObject.getState(), dataObject.getCity(), "110002",false);
