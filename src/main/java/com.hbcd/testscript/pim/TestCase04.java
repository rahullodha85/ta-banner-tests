 ...
 */
public class TestCase04 extends ScenarioBase {
    ...
    @Override
        ...
        //Thread.sleep(20000);
        Find.Object("pimTaskInputBox").input("SAKS SA");
        Thread.sleep(10000);
        Find.MultipleObjects("saksShoesTextSelection").select(8).click();
        Find.Object("saksAssignProduct_Set_Copy_Attribute").doubleClick();
        ...
        Find.MultipleObjects("pimCOMMDropBanner_CopyAttribute").select(6).click();

        nameSearch = "Saks Workflow";
        currentIndex = searchAndClickOnTab(currentIndex, nameSearch, listText);
        Thread.sleep(5000);*/

        Find.Object("PIMCOM_ScrollableClick").doubleClick();

        Find.Object("PIMF3S7_TuneIn_Task2_Assignment").click();
        Find.MultipleObjects("PIMCOM_DropDownButton").select(2).click();
        Thread.sleep(10000);
        Find.Object("PIMCOM_TuneInTask_Select_Yes").click();
