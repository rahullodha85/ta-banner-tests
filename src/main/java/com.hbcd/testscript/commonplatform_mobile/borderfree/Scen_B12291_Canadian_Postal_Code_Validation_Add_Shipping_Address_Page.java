 ...
 */
public class Scen_B12291_Canadian_Postal_Code_Validation_Add_Shipping_Address_Page extends ScenarioMobileSaks {
    public void executeScript() throws Exception {
        ...
        */
        ...
        shp.ClickNewShippingAddress();

        ValidateShipping.hasCanadaProvinceList();
        ValidateShipping.hasRegionProvinceText("canada");
        shp.EditShippingZipCode("12200");
        ValidateShipping.hasPostalCodeProvinceMismatch();
        shp.EditShippingZipCode("correct-zipCode");
        ValidateShipping.hasPostalCodeProvinceMatch();
