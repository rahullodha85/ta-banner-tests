 ...
 */
public class ScenB15167_S3 extends ScenarioMobileSaks {
    ...
    public void executeScript() throws Exception {
        ...
        pap.EnterPromotionalCode("FREESHIP");
        pap.EnterMobileGiftCardNumber("6022990000113475", "1467");
        pap.AddNewCreditCard(3, "test123", "test123");
        ValidateRs.hasGiftCardNumberDisplayed();
    }
