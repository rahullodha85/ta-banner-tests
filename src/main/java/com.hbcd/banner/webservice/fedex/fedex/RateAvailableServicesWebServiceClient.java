...
package com.hbcd.banner.webservice.fedex.fedex;
...
public class RateAvailableServicesWebServiceClient {  
	String deliverydatebuffer=null;
	String shippingtype=null;
	String replyrecieved=null;

   public  String callMain(com.hbcd.commonbanner.dataobjects.Address data) throws Exception {  
        	deliverydatebuffer=null;
        	shippingtype=null;
        	replyrecieved=null;
        ...
        Party shipper = new Party();
            ...
            shipperAddress.setStreetLines(new String[] {"1 Waldebooks Drive"});
    	    shipperAddress.setCity("La Vergne");
    	    shipperAddress.setStateOrProvinceCode("TN");
    	    shipperAddress.setPostalCode("37086");
        ...
        Party recipient = new Party();
            ...
            recipientAddress.setStreetLines(new String[] {data.getAddrss()});
    	    recipientAddress.setCity(data.getCity());
    	    System.out.println(data.getCity());
    	    recipientAddress.setStateOrProvinceCode(data.getState());
    	    recipientAddress.setPostalCode(data.getZip());
            ...
            rp.setWeight(new Weight(WeightUnits.LB, new BigDecimal(1.0)));
            //
            ...
            //
                try {
                        ...
                        System.out.println("Calling port.getRates()");
                        RateReply reply = port.getRates(request); // Service call
                        if (isResponseOk(reply.getHighestSeverity())) {
                                replyrecieved= writeServiceOutput(reply);
                        }
        ...
        public  String writeServiceOutput(RateReply reply) {
        	String transitTime=null;
                ...
                for (int i = 0; i < rrds.length; i++) {
                      ...
                      //  print("Packaging type", rrd.getPackagingType());
                        ...
                        if(rrd.getTransitTime()!= null){ 
                        	...
                        	transitTime= rrd.getTransitTime().toString();
                        }
                        if(rrd.getDeliveryTimestamp()!= null){
                        	//System.out.println(" --------- Step 1" +i);
                        	print("Delivery Date: ", dateFormat.format(rrd.getDeliveryTimestamp().getTime()));
                        	//System.out.println(" --------- Step 2" +i);
                        }
                        shippingtype=shippingtype+rrd.getServiceType()+"\n";
                        if(rrd.getDeliveryTimestamp()!=null){
                        deliverydatebuffer=deliverydatebuffer+dateFormat.format(rrd.getDeliveryTimestamp().getTime())+"\n";
                       // System.out.println( rrd.getTransitTime().toString());
                        }
                     ...
                     /*
                        for (int j = 0; j < rsds.length; j++) {
                           ...
                           //     print("  Rate Zone", srd.getRateZone());
               ...
               return (shippingtype +deliverydatebuffer+transitTime+"\n");
        }
        ...
        if (meterNumber == null) {
                meterNumber = "100045729"; // Replace "XXX" with clients meter number
        }
        ...
        //
        if (key == null) {
                key = "LZtR1c95nlFMMyq9"; // Replace "XXX" with clients key
        }
        if (password == null) {
                password = "I3ntPQFgkNsVC5qO77EGxZfTr"; // Replace "XXX" with clients password
        }
        wac.setKey(key);
