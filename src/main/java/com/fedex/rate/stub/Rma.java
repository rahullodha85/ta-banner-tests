...
public class Rma  implements java.io.Serializable {
    ...
    /**
     * Gets the number value for this Rma.
     * 
     * @return number   * Return Merchant Authorization Number
     */
    ...
    /**
     * Sets the number value for this Rma.
     * 
     * @param number   * Return Merchant Authorization Number
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v9", "Rma"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v9", "Reason"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
